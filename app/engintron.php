...
define('PLG_VERSION', '1.8.9');
define('PLG_BUILD', 'Build 20180416');
    ...
    <body class="op_<?php echo $op; ?>">
        ...
        <div id="ngContainer">
            ...
            <div id="ngOperations">
                ...
                <p id="commercialSupport"><b>Looking for commercial support?</b> <a href="mailto:engintron@gmail.com">Get in touch with us</a>.
            </div>
            <div id="ngOutput">
                <h2>&gt; Output</h2>
