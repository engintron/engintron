...
define('PLG_VERSION', '1.9.2');
define('PLG_BUILD', 'Build 20180817');
...
switch ($op) {
    ...
    case "engintron_update_stable":
        $ret = strip_tags(shell_exec("cd /; rm -f /engintron.sh; wget --no-check-certificate https://raw.githubusercontent.com/engintron/engintron/master/engintron.sh; bash engintron.sh update"), "<br><span>");
        break;

    case "engintron_update_mainline":
        $ret = strip_tags(shell_exec("cd /; rm -f /engintron.sh; wget --no-check-certificate https://raw.githubusercontent.com/engintron/engintron/master/engintron.sh; bash engintron.sh update mainline"), "<br><span>");
        break;
