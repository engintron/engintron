...
### Engintron v2.1 (Build 20220916) / Updated on September 16th, 2022
...
As such, as of January 2022, Engintron is fully compatible with CentOS 6 with CloudLinux (the only actively supported Enterprise Linux variant by cPanel as CentOS 6 is officially EOL since 2020), CentOS 7 and all EL 8 variants such as AlmaLinux, EuroLinux, Rocky Linux & CentOS 8 (for which support by Red Hat stopped at the end of 2021).
